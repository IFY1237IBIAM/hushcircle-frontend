...
const WifiOffIcon      = ({ size = 38, color }) => (
...
const SignalIcon       = ({ size = 38, color }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M1.42 9a16 16 0 0 1 21.16 0" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M5 12.55a11 11 0 0 1 14.08 0" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M8.53 16.11a6 6 0 0 1 6.95 0" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    <Line x1="12" y1="20" x2="12.01" y2="20" stroke={color} strokeWidth={2.5} strokeLinecap="round" />
  </Svg>
);
const MessageIcon      = ({ size = 38, color }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
const ReplyIcon        = ({ size = 38, color }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Polyline points="9 17 4 12 9 7" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    <Path d="M20 18v-2a4 4 0 0 0-4-4H4" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);
const HeartIcon        = ({ size = 38, color }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
const BookmarkIcon     = ({ size = 38, color }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
const WifiOffSmallIcon = ({ size = 13, color }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// ── Action config — Icon constructors only, colors applied at render time ──
  ...
  return (
    <Modal visible={visible} transparent animationType="none" onRequestClose={onClose}>
      <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.78)", justifyContent: "center", alignItems: "center", padding: 24 }}>
        <Animated.View style={{ backgroundColor: C.card, borderRadius: 28, padding: 28, width: "100%", maxWidth: 340, alignItems: "center", borderWidth: 1, borderColor: C.border, opacity: opacityAnim, transform: [{ scale: scaleAnim }] }}>

          {/* Context icon */}
          <View style={{ width: 80, height: 80, borderRadius: 40, backgroundColor: C.border, justifyContent: "center", alignItems: "center", marginBottom: 16 }}>
            <config.Icon size={38} color={C.textMuted} />
          </View>

          <Text style={{ color: C.text, fontFamily: "DMSerifDisplay_400Regular", fontSize: 24, marginBottom: 10, textAlign: "center" }}>{config.title}</Text>
          <Text style={{ color: C.textMuted, fontFamily: "Nunito_400Regular", fontSize: 14, textAlign: "center", lineHeight: 22, marginBottom: 16 }}>{config.message}</Text>

          {/* No-wifi badge */}
          <View style={{ flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: C.border, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 7, marginBottom: 22 }}>
            <WifiOffSmallIcon size={12} color={C.textMuted} />
            <Text style={{ color: C.textMuted, fontFamily: "Nunito_500Medium", fontSize: 12 }}>No internet · Check your connection</Text>
          </View>

          {/* Actions */}
          <View style={{ flexDirection: "row", gap: 10, width: "100%" }}>
            {onClose && (
              <TouchableOpacity style={{ flex: 1, padding: 14, borderRadius: 14, borderWidth: 1, borderColor: C.border, alignItems: "center" }} onPress={onClose}>
                <Text style={{ color: C.textMuted, fontFamily: "Nunito_500Medium", fontSize: 14 }}>Dismiss</Text>
              </TouchableOpacity>
            )}
            {onRetry && (
              <TouchableOpacity style={{ flex: 1, padding: 14, borderRadius: 14, backgroundColor: C.accent, alignItems: "center" }} onPress={onRetry}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 7 }}>
                  <RefreshIcon size={13} color="#fff" />
                  <Text style={{ color: "#fff", fontFamily: "Nunito_600SemiBold", fontSize: 14 }}>Try again</Text>
                </View>
              </TouchableOpacity>
            )}
          </View>
